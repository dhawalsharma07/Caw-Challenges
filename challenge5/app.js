...
const addEpisodes =()=>{
 episodes.forEach(episode => {
      const episodeListNode= getEpisodeListNode(episode.name,episode.id);
      const episodeNode= document.querySelector('.episodes');

      episodeNode.appendChild(episodeListNode);
 });
}
addEpisodes();